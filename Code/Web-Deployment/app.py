...
labels = {
    0: {
        'id': 1,
        'name': 'Apple Scab',
        'description': 'Apple scab is a disease of Malus trees, such as apple trees, caused by the ascomycete fungus Venturia inaequalis. The disease manifests as dull black or grey-brown lesions on the surface of tree leaves, buds or fruits. Lesions may also appear less frequently on the woody tissues of the tree. Fruits and some vegetative tissues may become deformed or cracked and trees may defoliate prematurely. The disease rarely kills its host, but can significantly reduce fruit yields and fruit quality. Affected fruits are less marketable due to the presence of the black fungal lesions.',
        'treatment': 'Prune out infected branches and twigs during the dormant season. Rake and destroy fallen leaves to reduce the number of fungal spores available to start the disease cycle over again next spring. Fungicide sprays are most effective when applied during the spring.',
    ...
    1: {
        ...
        'description': 'Black rot is a disease of grapes caused by an ascomycetous fungus, Guignardia bidwellii, also known as Phyllosticta ampelicida. It is a common problem in warm, humid climates and can destroy entire crops if left untreated. The fungus forms pycnidia on infected grapevines during the fall. These pycnidia then release spores which are carried by wind and rain to other parts of the plant, where they cause new infections the following spring.',
        'treatment': 'Prune out infected branches and twigs during the dormant season. Rake and destroy fallen leaves to reduce the number of fungal spores available to start the disease cycle over again next spring. Fungicide sprays are most effective when applied during the spring.',
        'suggested_pesticides': 'Chlorothalonil, Mancozeb, Propiconazole, Myclobutanil, Pyraclostrobin, Tebuconazole, Thiophanate-methyl, Trifloxystrobin, Copper, Sulfur'
    },
    2: {
        ...
        'description': 'Cedar-apple rust is a fungal disease that requires juniper plants to complete its complicated two year life-cycle. The fungus spends a portion of its life cycle on Eastern red cedar (Juniperus virginiana) and a portion on apple (Malus spp.) or crabapple (Malus spp.) trees. The fungus spends the winter on cedar trees as a reddish-brown gall on the twigs. In the spring, these galls swell and become covered with orange gelatinous tendrils. These tendrils release spores that are carried by the wind to apple or crabapple trees. On apple or crabapple trees, the spores infect the leaves and fruit. The fungus then spends the summer on apple or crabapple trees as a yellowish-brown spot on the leaves or fruit. In the fall, the fungus produces spores that are carried by the wind back to cedar trees to complete the cycle.',
        'treatment': 'Remove nearby Cedar trees. Fungicides can be used to prevent infection of apple trees.',
        'suggested_pesticides': 'Chlorothalonil, Mancozeb, Propiconazole, Myclobutanil, Pyraclostrobin, Tebuconazole, Thiophanate-methyl, Trifloxystrobin, Copper, Sulfur'
    },
    3: {
        'id': 4,
        'name': 'Healthy Apple',
        'description': 'This is a healthy apple leaf.',
